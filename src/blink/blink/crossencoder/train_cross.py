...
import src.blink.blink.candidate_retrieval.utils
...
from src.blink.blink.biencoder.zeshel_utils import DOC_PATH, WORLDS, world_to_id
from src.blink.blink.common.optimizer import get_bert_optimizer
