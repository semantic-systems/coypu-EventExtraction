...
from src.blink.blink.common.ranker_base import BertEncoder, get_model_obj
from src.blink.blink.common.optimizer import get_bert_optimizer
from src.blink.blink.common.params import ENT_START_TAG, ENT_END_TAG, ENT_TITLE_TAG
